...
import { Grid, Typography, Card, CardContent, Image } from '@material-ui/core'
import image from '../img/announcement_1.png';
const Announcements = () => {
    return (
                ...
                <CardContent>
                    <Grid container style={{ justifyContent: "center", alignItems: "center" }}>
                        <Grid item sm={10} md={10} xs={10} lg={8}>
                            <img src={image} alt="" style={{ width: "80%", height: "auto" }} />
                        </Grid>
